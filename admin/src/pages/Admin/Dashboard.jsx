...
const Dashboard = () => {
    ...
    return dashData && (
        ...
        <div className='bg-white max-w-4xl rounded-lg shadow-sm'>

            <div className='flex items-center gap-2.5 px-6 py-4 mt-10 bg-gray-50 rounded-t-lg border-b'>
            ...
            <div className='divide-y'>
                {
                    dashData.latestAppointments.map((item,index)=>(
                        <div className='flex items-center px-6 py-4 gap-4 hover:bg-gray-50 transition-all' key={index}>
                            <img className='rounded-full w-12 h-12 object-cover' src={item.docData.Image || item.docData.image} alt="" />
